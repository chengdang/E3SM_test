...
#SBATCH  --job-name=exp.SnicarTrue.Write.cmip6-picontrol.run
#SBATCH  --nodes=39
#SBATCH  --output=exp.SnicarTrue.Write.cmip6-picontrol.run.%j 
#SBATCH  --exclusive 
...
# cd to case
cd /global/u2/c/cdang/E3SM_code_v1_mdf/20180420_SW_snicar/cime/scripts/exp.SnicarTrue.Write.cmip6-picontrol
...
srun  --label  -n 936  -c 2  --cpu_bind=cores  /global/cscratch1/sd/cdang/acme_scratch/edison/exp.SnicarTrue.Write.cmip6-picontrol/bld/e3sm.exe  >> e3sm.log.$LID 2>&1 
